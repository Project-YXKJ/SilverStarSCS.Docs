...
This chapter gives an introduction on how to interact with this document.
This assumes you are reading an HTML site. The options and formatting will be different
for other output formats such as epub.

A document is organized into **chapters**. Each chapter is a separate page. Chapters can be 
...
The menu bar at the top of the page provides some icons for interacting with the document.
